...
module.exports = React.createClass({
  ...
  renderText() {
    switch(this.state.connectionState) {
      case "disconnected":
        return <span><i className="glyphicon glyphicon-remove-circle"></i> Disconnected. Waiting for reconnection attempt... </span>;
      case "reconnectAttempt":
        return <span><i className="glyphicon glyphicon-hourglass"></i> Reconnect attempt...</span>;
      case "reconnecting":
        return <span><i className="glyphicon glyphicon-hourglass"></i> Reconnecting... ({this.state.reconnectionAttempt} attempt)</span>;
      case "reconnectError":
        return <span><i className="glyphicon glyphicon-remove-circle"></i> Connection Error. Wait for next attempt...</span>;
